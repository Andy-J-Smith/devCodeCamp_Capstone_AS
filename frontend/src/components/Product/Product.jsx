  ...
  return (
    <div className="product-container">
      <Card className="good" style={{ width: "20rem" }}>
        <Card.Img className="image" variant="top" src="https://media.istockphoto.com/photos/fishing-equipment-picture-id625780716?b=1&k=20&m=625780716&s=170667a&w=0&h=BVX_Ii6OsENxtQGRlIY84GhDwhOYGPQ3GUYq08bdy7E=" />
        <Card.Body>
      ...
      <Card className="best" style={{ width: "20rem" }}>
        ...
        <Card.Body>
          <Card.Title><h2 className="title-best">Slab Slayer Package</h2></Card.Title>
          <Card.Text>
            <li>Hooks</li>
            <li>Sinkers</li>
            <li>Bobbers</li>
