...
const Billing = (props) => {
    ...
    async function updateAddress( newCust) {
      try {
        let response = await axios.post(
          `http://127.0.0.1:8000/api/customers/`,newCust,{
            headers: {
              Authorization: "Bearer " + token,
            },
          }
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              ...
              <form className="survey-form" onSubmit={handleUpdate}>
                ...
                />
                <button type="submit"onClick={handleClose}>Add Billing Address </button>
              </form>
            </Modal.Body>
